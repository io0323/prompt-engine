...
import promptengine.engine.pipeline.NoopPipelineTracer
...
class PluginEngineConfig {
    ...
    /** 実OpenTelemetry実装（Issue #38）が入るまでの既定Tracer。何もSpanを記録しない。 */
    @Bean
    fun pipelineTracer(): PipelineTracer = NoopPipelineTracer()
}
